...
func (s *Server) handleUpdateUser(w http.ResponseWriter, r *http.Request) {
	...
	user, err := s.db.UpdateUserEmailAndPassword(r.Context(), database.UpdateUserEmailAndPasswordParams{
		Email:          params.Email,
		HashedPassword: hashedPass,
		ID:             userId,
	})
...
func (s *Server) handleUpgradeToChirpyRed(w http.ResponseWriter, r *http.Request) {
	type parameters struct {
	...
	err = s.db.UpgradeToChirpyRed(r.Context(), uid)
	if err != nil {
